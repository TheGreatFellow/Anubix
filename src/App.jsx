                    ...
                    <div className='hero' data-scroll-section>
                        ...
                        <nav>
                            ...
                            <p
                                ...
                                data-scroll-speed={2}
                            >
                                Reintroducing the classics of the good old times
                                of '97
                            </p>
                        </nav>
                        ...
                        <div className='section1'>
                            ...
                            >
                                <p className='glassInfo' data-scroll>
                                    Nike Air Max 97 shook up the running world
                                    with og ripple design and crisp color
                                    accents
                                </p>
                            </div>
                            <div
                        ...
                        <div className='section1' style={{ height: '100%' }}>
                            ...
                            >
                                <p
                                    ...
                                    // data-scroll-speed={2}
                                >
                                    Featuring the ripple design, Air Max 97 SE
                                    goes a little wild with animal print accents
                                    for women
                                </p>
                            </div>
                            <div
